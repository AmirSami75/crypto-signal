...
export const fa = {
  ...
  validation: {
    ...
    botAtrPositive: 'ضریب ATR باید عددی مثبت باشد',
  ...
  trading: {
    ...
    venue: {
      ...
      BinanceFuturesTestnet: 'بایننس - شبکه آزمایشی فیوچرز',
    ...
    takeProfitAtrMultiple: 'ضریب ATR حد سود',
    stopLossAtrMultiple: 'ضریب ATR حد ضرر',
  ...
  signal: {
    ...
    takeProfitAtrMultipleHint: 'وقتی پر باشد، به جای درصد، فاصله بر حسب ATR استفاده می‌شود (مثلا ۲ یعنی دو برابر ATR)',
    bracketsLabel: 'حد سود / حد ضرر',
    stopLossAtrMultipleHint: 'وقتی پر باشد، حد ضرر بر حسب ATR محاسبه می‌شود',
  ...
  bots: {
    ...
    leverage: 'اهرم',
    estimatedNotional: 'ارزش ناخالص موقعیت',
    estimatedMargin: 'حاشیه تخمینی',
    estimatedMarginHint: 'ارزش ناخالص تقسیم بر اهرم. مبلغی که در هر سفارش درگیر می‌شود.',
    availableQuoteBalance: 'موجودی آزاد',
    availableQuoteBalanceHint: 'موجودی تتر آزاد در صرافی، هنگامی که یک بررسی ریسک زنده آن را خوانده باشد.',
  ...
  /** Market scanner: strategy-zoo proposals ranked by change and volume. */
  scanner: {
    title: 'اسکنر بازار',
    subtitle: 'سیگنال‌های استراتژی‌های فنی روی نمادهای پرنوسان بازار؛ پیشنهاد هستند، نه سفارش',
    symbol: 'نماد',
    strategy: 'استراتژی',
    direction: 'جهت',
    confidence: 'اطمینان',
    ...
    reason: 'دلیل',
    age: 'زمان',
    symbolFilter: 'فیلتر نماد',
    strategyFilter: 'فیلتر استراتژی',
    clearFilters: 'پاک کردن فیلترها',
    loadFailed: 'خطا در بارگذاری سیگنال‌ها',
    loadFailedBody: 'دوباره تلاش کنید',
    emptyTitle: 'سیگنالی ثبت نشده',
    emptyBody: 'اسکنر هنوز سیگنالی برای نمایش پیدا نکرده است',
    justNow: 'همین حالا',
  ...
  /** M Engine page: model metadata, calibration, and supported-market listing. */
  mlEngine: {
    stateReady: 'موتور آماده است',
    stateNotReady: 'موتور در دسترس نیست',
    stateLowCeiling: 'موتور در دسترس است، اما اطمینان مدل پایین است',
    capsLoadFailed: 'بارگذاری قابلیت موتور یادگیری ماشین با خطا مواجه شد',
    modelLoadFailed: 'بارگذاری اطلاعات مدل با خطا مواجه شد',
    capabilitiesLabel: 'خلاصه موتور',
    activeModelLabel: 'مدل فعال',
    serviceLabel: 'سرویس',
    versionLabel: 'نسخه',
    protocolLabel: 'پروتکل',
    minCandlesLabel: 'حداقل کندل مورد نیاز',
    marketsLabel: 'بازارهای پوشش‌دهی‌شده',
    marketsCaption: 'نماد و بازه‌های مدل',
    wildcardLabel: 'مدل عمومی (wildcard)',
    modelVersionLabel: 'نسخه مدل',
    modelVersionNote: 'ربع‌اول شناسهٔ گیت',
    trainedAtLabel: 'زمان آموزش',
    trainedAtNote: 'آخرین بار مدل آموزش دیده',
    featureCountLabel: 'تعداد ویژگی',
    featureCountNote: 'ورودی‌های استفاده‌شده توسط مدل',
    confidenceCeilingLabel: 'حداکثر اطمینان',
    confidenceCeilingNote: 'بالاترین امتیاز روی دادهٔ معتبر',
    holdingPeriodsLabel: 'حداکثر دوره نگهداری',
    holdingPeriodsNote: 'تعداد کندل حداکثر در یک موقعیت',
    labelSchemeLabel: 'سیاست برچسب',
    calibrationMethodLabel: 'روش کالیبراسیون',
    lastRefreshLabel: 'به‌روز شده در',
    modelLoadingLabel: 'در حال بارگذاری مدل',
    lowCeilingWarning: 'حداکثر اطمینان مدل زیر آستانه هشدار است؛ ممکن است دقت تصمیم‌ها افت کرده باشد. کالیبراسیون را بررسی کنید.',
    confidenceCeilingLowNote: 'زیر آستانه هشدار — کالیبراسیون ممکن است دچار رانش شده باشد',
    calibrationLabel: 'کالیبراسیون اطمینان',
    calibrationNote:
      'خط نشان می‌دهد که اطمینان بالاتر چه سهمی از صفرها را تشکیل می‌دهد؛ خط صاف یا معکوس اولین نشانهٔ رانش مدل است.',
    modelNotReady: 'مدل برای سرویس فعال در دسترس نیست',
    noMarkets: 'بازاری یافت نشد',
    noMarketsNote: 'موتور در حال حاضر هیچ بازاری را پوشش نمی‌دهد. بررسی کنید آیا مدلی بارگذاری شده است.',
    showAllMarkets: 'نمایش همه',
    hideMarkets: 'پنهان‌کردن',
    moreMarkets: 'بازار دیگر',
    colSymbol: 'نماد',
    colInterval: 'بازه',
    colVersion: 'نسخه مدل',
    colWildcard: 'عمومی',
